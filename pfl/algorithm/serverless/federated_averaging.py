...
FedAvgCentralContextType = CentralContext[NNAlgorithmParamsType, ModelHyperParamsType]


class ServerlessFederatedAveraging(
    ServerlessFederatedNNAlgorithm[
        NNAlgorithmParamsType, ModelHyperParamsType, StatefulModelType, WeightedStatistics, AbstractDatasetType
    ]
):
    """
    ...
    def train_one_user(
        ...
        # Local training loop
        bridges.sgd_bridge().do_sgd(model, user_dataset, central_context.model_train_params)
